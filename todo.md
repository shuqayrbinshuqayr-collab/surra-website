...
## صفحة تفاصيل الجهة (Entity Detail Page)
- [x] إنشاء EntityDetail.tsx بتصميم احترافي يعرض جميع المعلومات
- [x] إضافة procedure getById في directory router (موجود بالفعل)
- [x] ربط النقر على الجهات في الدليل بصفحة التفاصيل
- [x] إضافة مسار `/directory/:id` في App.tsx
- [x] عرض الشعار والفئة والعنوان والوصف والتواصل والموقع الإلكتروني
- [x] إضافة زر العودة إلى الدليل
