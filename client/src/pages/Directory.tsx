...
const initialEntities: Entity[] = [
  { id: 1, name: "حي جميل", category: "مساحات", type: "مساحة إبداعية", city: "جدة", focus: "فنون بصرية وسينما", desc: "مجمع إبداعي متكامل بمساحة 17,000م² يضم 12 منظمة شريكة، استوديوهات، مسرح، وأول دار سينما مستقلة في المملكة.", tags: ["#فنون", "#سينما", "#ريادة", "#جدة"], activity: "نشط جداً", instagram: "@artjameel", partnership: "عالية", year: 2021, isNew: false },
  { id: 2, name: "الجمعية العربية السعودية للثقافة والفنون", category: "شركات", type: "جمعية", city: "الرياض", focus: "مسرح وموسيقى وفنون بصرية", desc: "الكيان الرائد في خدمة الحراك الثقافي منذ 1973، تمتد عبر 16 فرعاً في المملكة مع أكثر من 11,000 عضو.", tags: ["#مسرح", "#موسيقى", "#فنون_بصرية", "#وطني"], activity: "نشط جداً", instagram: "@sasca_sa", partnership: "عالية", year: 1973, isNew: false },
  { id: 3, name: "جاكس — منطقة الدرعية الثقافية", category: "مساحات", type: "مساحة إبداعية", city: "الرياض", focus: "تصوير وتصميم وفنون معاصرة", desc: "حي ثقافي في قلب الدرعية يستضيف معارض وورشات في التصوير الفوتوغرافي، النحت، والتصميم الغرافيكي.", tags: ["#درعية", "#تصميم", "#تراث", "#معاصر"], activity: "نشط جداً", instagram: "@diriyahgate", partnership: "عالية", year: 2022, isNew: false },
  { id: 4, name: "بلد الفن", category: "منصات", type: "مبادرة", city: "جدة", focus: "فنون بصرية وتراث محلي", desc: "مبادرة وزارة الثقافة التي تحوّل جدة التاريخية إلى مركز إبداعي ثقافي بمعارض تعكس التراث بأساليب عصرية.", tags: ["#جدة_التاريخية", "#تراث", "#فنون", "#وزارة_الثقافة"], activity: "نشط", instagram: "@ministryofculture", partnership: "عالية", year: 2024, isNew: false },
  { id: 5, name: "مركز إثراء", category: "مساحات", type: "مساحة إبداعية", city: "الدمام", focus: "ثقافة وفنون ومعرفة", desc: "مركز إثراء للمعرفة والفنون والثقافة في الظهران، يضم متحفاً ومسرحاً وحاضنة أعمال إبداعية.", tags: ["#إثراء", "#أرامكو", "#معرفة", "#شرقية"], activity: "نشط جداً", instagram: "@ithra", partnership: "عالية", year: 2018, isNew: false },
  { id: 6, name: "فنون العلا", category: "منصات", type: "مبادرة", city: "العلا", focus: "فنون معاصرة وتراث صحراوي", desc: "مهرجان فنون عالمي في العلا يجمع الفنانين المحليين والدوليين وسط التضاريس الصحراوية الساحرة.", tags: ["#العلا", "#فنون_عالمية", "#صحراء", "#سياحة"], activity: "نشط", instagram: "@experiencealula", partnership: "متوسطة", year: 2020, isNew: false },
  { id: 7, name: "النادي الأدبي الثقافي جدة", category: "شركات", type: "جمعية", city: "جدة", focus: "أدب وشعر وخط عربي", desc: "نادٍ أدبي ثقافي يقدم ورشات في الخط العربي والشعر، ويحتضن منتدى الفنون البصرية.", tags: ["#أدب", "#خط_عربي", "#شعر", "#جدة"], activity: "نشط", instagram: "@jeddahliterary", partnership: "متوسطة", year: 1975, isNew: false },
  { id: 8, name: "مبادرة الشريك الأدبي", category: "منصات", type: "مبادرة", city: "الرياض", focus: "أدب ومقاهٍ ثقافية", desc: "مبادرة وزارة الثقافة لتحويل 80 مقهى في 12 منطقة إدارية إلى مساحات إبداعية وأدبية.", tags: ["#مقاهي", "#أدب", "#وزارة_الثقافة", "#وطني"], activity: "نشط جداً", instagram: "@ministryofculture", partnership: "عالية", year: 2023, isNew: false },
  { id: 9, name: "مجتمع سرة", category: "شركات", type: "مجتمع", city: "الرياض", focus: "اقتصاد إبداعي وحراك ثقافي", desc: "منظومة متكاملة تغير مفاهيم الحراك الثقافي وتستثمر في الاقتصاد الإبداعي السعودي عبر بناء مجتمعات فنية حية.", tags: ["#سرة", "#اقتصاد_إبداعي", "#مجتمع", "#ريادة"], activity: "نشط جداً", instagram: "@surrah_community", partnership: "عالية", year: 2022, isNew: true },
  { id: 10, name: "ستوديو بيان", category: "متاجر", type: "استوديو", city: "الرياض", focus: "تصميم جرافيك وهوية بصرية", desc: "استوديو تصميم متخصص في الهوية البصرية والتصميم الجرافيكي للعلامات التجارية الإبداعية.", tags: ["#تصميم", "#هوية_بصرية", "#جرافيك"], activity: "نشط", instagram: "@bayan_studio", partnership: "متوسطة", year: 2020, isNew: false },
  { id: 11, name: "متجر الفنون السعودية", category: "متاجر", type: "متجر", city: "جدة", focus: "بيع الأعمال الفنية المحلية", desc: "منصة تجارية لبيع الأعمال الفنية السعودية الأصيلة من لوحات وتماثيل ومنتجات إبداعية.", tags: ["#فنون", "#تجارة_إبداعية", "#جدة"], activity: "نشط", instagram: "@saudiartstore", partnership: "متوسطة", year: 2021, isNew: true },
];

const CATEGORIES = [
  { key: "الكل", label: "الكل", icon: "◈" },
  { key: "شركات", label: "شركات", icon: "⬡" },
  { key: "منصات", label: "منصات", icon: "◉" },
  { key: "مساحات", label: "مساحات", icon: "⊞" },
  { key: "متاجر", label: "متاجر", icon: "⊛" },
];

const CITIES = ["", "الرياض", "جدة", "الدمام", "العلا", "أبها", "المدينة المنورة", "تبوك", "الطائف", "الأحساء"];
const TYPES = ["", "مجتمع", "مساحة إبداعية", "جمعية", "مقهى ثقافي", "مبادرة", "استوديو", "مؤسسة داعمة", "متجر"];
