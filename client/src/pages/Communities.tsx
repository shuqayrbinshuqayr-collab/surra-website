...
const communitiesData = {
  ...
  zh: [
    ...
    { id: "maqam", name: "马卡姆", color: "#C4622D", tagline: "一个恢复听觉地位、语言感觉和声音传达能力的社区。", description: "马卡姆是一个恢复声音价值的社区。专注于音乐、声音、朗诵和声音表达。为那些相信声音是超越文字的语言的人提供的空间。", type: "音乐与声音", audience: "对音乐、声音和表达感兴趣的人", meetings: "每月" },
  ],
};
