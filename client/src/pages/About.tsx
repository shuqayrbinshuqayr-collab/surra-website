/* ============================================================
   ...
   Sections: Hero, Who is Surra, Vision, Mission, Values, How We Work
   ============================================================ */
    ...
    <div ref={pageRef} style={{ background: "oklch(0.08 0.01 60)", minHeight: "100vh" }}>
      ...
      >
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "linear-gradient(to bottom, oklch(0.06 0.01 60 / 80%), oklch(0.06 0.01 60 / 90%))",
          }}
        />
      ...
      >
        <div className="container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px" style={{ background: "oklch(0.25 0.02 75 / 15%)" }}>
            ...
            >
              <span
                className="block text-xs mb-4 tracking-widest"
                style={{
                  color: "oklch(0.72 0.12 75)",
                  fontFamily: "'IBM Plex Sans Arabic', sans-serif",
                  letterSpacing: "0.2em",
            ...
            <div
              id="mission"
              className="reveal p-10 md:p-14"
              style={{ background: "oklch(0.08 0.01 60)", transitionDelay: "0.15s" }}
            >
              <span
                className="block text-xs mb-4 tracking-widest"
                style={{
