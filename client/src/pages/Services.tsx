/* ============================================================
   ...
   Sections: Hero, 4 Services in detail, CTA
   ============================================================ */
...
const services = [
  {
    ...
    description:
      "نرافق المبادرات والجهات والعلامات التجارية في تحويل رؤاها إلى مجتمعات حية. نبدأ من الجذور: من الهوية والغاية والإنسان، لا من الشكل والواجهة.",
    points: [
      "بناء هوية المجتمع",
      "تحديد الفئة المستهدفة",
      "الهيكلة والتنظيم",
      "خطط التشغيل والاستدامة",
    ],
  ...
  },
  {
    ...
    description:
      "نحول الأفكار والمعرفة إلى برامج ثقافية حية تُشعل الفضول وتبني الانتماء. كل برنامج هو رحلة مصممة بعناية لتحقيق أثر حقيقي.",
    points: [
      "برامج حوارية",
      "سلاسل معرفية",
      "تجارب ثقافية متخصصة",
  ...
  },
  {
    ...
    description:
      "نُدير الفعاليات الثقافية والإبداعية من الفكرة حتى التوثيق. نُصمم التجربة بالكامل لتكون لحظة تُعاش وذكرى تبقى.",
    points: [
      "تصميم التجربة",
      "إدارة الحدث وتشغيله",
      "إدارة الحضور",
  ...
  },
  {
    ...
    description:
      "نربط العلامات التجارية والمبادرات بجمهورها الحقيقي. لدينا شبكة من المجتمعات المتخصصة تُمكّننا من الوصول الدقيق والمؤثر.",
    points: [
      "بناء مجتمعات متخصصة",
      "إدارة قواعد الجمهور",
      "ربط العلامات التجارية بجمهورها الحقيقي",
    ],
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            >
              نرافقك من الفكرة
              <br />
              <span style={{ color: "oklch(0.72 0.12 75)" }}>حتى الاستدامة</span>
            </h1>
            <p
              style={{
                fontFamily: "'IBM Plex Sans Arabic', sans-serif",
          ...
          <div className="space-y-px" style={{ background: "oklch(0.25 0.02 75 / 15%)" }}>
            {services.map((service, i) => (
              <div
                key={service.id}
                id={service.id}
                className="reveal grid grid-cols-1 lg:grid-cols-3 gap-0"
                style={{
              ...
              >
                {/* Number + Title */}
                <div
                  className="p-8 md:p-12 lg:border-l"
      ...
      <section className="py-24" style={{ background: "oklch(0.08 0.01 60)" }}>
        <div className="container text-center">
          <div className="reveal max-w-xl mx-auto">
            ...
            >
              نؤمن أن كل حوار جاد هو بداية…
            </p>
            <Link href="/contact" className="btn-gold-filled text-base px-8 py-3.5">
              تواصل معنا ←
            </Link>
          </div>
        </div>
